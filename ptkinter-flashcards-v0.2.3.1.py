...
mixer.init()
soundCorrect = mixer.Sound('assets/sounds/correct.wav')
soundWrong = mixer.Sound('assets/sounds/wrong.wav')
soundCountdown = mixer.Sound('assets/sounds/countdown.wav')
soundCountdownStart = mixer.Sound('assets/sounds/countdownstart.wav')
soundTimesup = mixer.Sound('assets/sounds/timesup.wav')
soundClockticking = mixer.Sound('assets/sounds/clockticking.wav')
