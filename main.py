...
startscreen_canvas = Canvas(window, bg=windowcolor, height=500,
                            width=800, bd=0, highlightthickness=0, relief="ridge")
mainscreen_canvas = Canvas(window, bg=windowcolor, height=500,
                           width=800, bd=0, highlightthickness=0, relief="ridge")
optionsscreen_canvas = Canvas(window, bg=windowcolor, height=500,
                              width=800, bd=0, highlightthickness=0, relief="ridge")
finalscreen_canvas = Canvas(window, bg=windowcolor, height=500,
                            width=800, bd=0, highlightthickness=0, relief="ridge")
historyscreen_canvas = Canvas(window, bg=windowcolor, height=500,
                              width=800, bd=0, highlightthickness=0, relief="ridge")
userscreen_canvas = Canvas(window, bg=windowcolor, height=500,
                           width=800, bd=0, highlightthickness=0, relief="ridge")
profilescreen_canvas = Canvas(window, bg=windowcolor, height=500,
                              width=800, bd=0, highlightthickness=0, relief="ridge")
...
class UserScreen():
    ...
    image_usericon = PhotoImage(
        file=relative_to_assets("userscreen/usericon.png"))
    image_useradd = PhotoImage(
        file=relative_to_assets("userscreen/useradd.png"))
    image_backbutton = PhotoImage(
        file=relative_to_assets("userscreen/backbutton.png"))
    image_userremove = PhotoImage(
        file=relative_to_assets("userscreen/userremove.png"))
    image_popup_banner = PhotoImage(
        file=relative_to_assets("userscreen/popup_banner.png"))
    image_popup_text = PhotoImage(
        file=relative_to_assets("userscreen/popup_text.png"))
    ...
    image_entry_bg = PhotoImage(
        file=relative_to_assets("userscreen/entry_bg.png"))
    image_verify_bg = PhotoImage(
        file=relative_to_assets("userscreen/verify_bg.png"))
    ...
    image_confirm = PhotoImage(
        file=relative_to_assets("userscreen/confirm.png"))
    ...
    bg_image = userscreen_canvas.create_image(
        395.0, 255.0, image=image_bg_image)
    ...
    usericon1_bg = userscreen_canvas.create_image(
        299.0, 178.0, image=image_usericon_bg)
    usericon2_bg = userscreen_canvas.create_image(
        299.0, 257.0, image=image_usericon_bg)
...
class ProfileScreen():
    ...
    history_bg = profilescreen_canvas.create_image(
        399.0, 451.0, image=image_action_bg)
    edit_bg = profilescreen_canvas.create_image(
    ...
    grade_text = profilescreen_canvas.create_text(
        291.0, 117.0, anchor="nw", text="A+", fill="#000000", font=("Encode Sans", 17 * -1))
    average_percent = profilescreen_canvas.create_text(
        326.0, 154.0, anchor="nw", text="95", fill="#000000", font=("Encode Sans", 17 * -1))
    highest_score = profilescreen_canvas.create_text(
        346.0, 192.0, anchor="nw", text="63", fill="#000000", font=("Encode Sans", 17 * -1))
    highest_score_mode = profilescreen_canvas.create_text(
        394.0, 228.0, anchor="nw", text="*-easy-2:00", fill="#000000", font=("Encode Sans", 17 * -1))
    favorite_mode = profilescreen_canvas.create_text(
        354.0, 265.0, anchor="nw", text="*-easy-2:00", fill="#000000", font=("Encode Sans", 17 * -1))
...
class StartScreen():
    ...
    button_leaderboard = Button(startscreen_canvas, image=image_leaderboard, borderwidth=0, activebackground="#C3C3C3",
                                bg="#D9D9D9", highlightthickness=0, command=lambda: print("button_2 clicked"), relief="flat")
...
class MainScreen():
    ...
    buttonbox_2 = mainscreen_canvas.create_image(
        161.0, 381.0, image=image_buttonbox)
    buttonbox_3 = mainscreen_canvas.create_image(
        64.0, 34.0, image=image_buttonbox)
    ...
    flashcard2_text = mainscreen_canvas.create_text(
        359.0, 184.0, anchor="nw", text=flashcard1, fill="#000000", font=("Helvetica", 70 * -1))
    flashcard1_text = mainscreen_canvas.create_text(
        359.0, 116.0, anchor="nw", text=flashcard2, fill="#000000", font=("Helvetica", 70 * -1))
    time_text = mainscreen_canvas.create_text(
        591.0, 113.0, anchor="nw", text='', fill="#000000", font=("Encode Sans", 40 * -1))
    feedback_text = mainscreen_canvas.create_text(
        359.0, 360.0, anchor="nw", text=feedback, fill="#000000", font=("Encode Sans", 30 * -1))
    highscore_text = mainscreen_canvas.create_text(
        160.0, 250.0, anchor="center", text='', fill="#000000", font=("Encode Sans", 23 * -1))
    currentscore_text = mainscreen_canvas.create_text(
        160, 163.0, anchor="center", text='', fill="#000000", font=("Encode Sans", 23 * -1))
    correctanswer_text = mainscreen_canvas.create_text(
        640.0, 222.0, anchor="center", text='', fill="#000000", font=("Encode Sans", 38 * -1))
    mainscreen_canvas.create_text(
        103.0, 187.0, anchor="nw", text="High Score", fill="#000000", font=("Encode Sans", 25 * -1))
    mainscreen_canvas.create_text(
        88.0, 103.0, anchor="nw", text="Current Score", fill="#000000", font=("Encode Sans", 25 * -1))
    ...
    entrybox = Entry(mainscreen_canvas, bd=0, bg="#D9D9D9", fg="#000716", highlightthickness=0, font=(
        "Encode Sans", 13), validate='key', validatecommand=(mainscreen_validate_cmd, '%P'))
...
class OptionsScreen():
    ...
    banner9_2 = optionsscreen_canvas.create_image(
        399.0, 166.0, image=image_banner9)
    banner9_3 = optionsscreen_canvas.create_image(
        666.0, 166.0, image=image_banner9)
    ...
    description_title = optionsscreen_canvas.create_text(
        215.0, 330.0, anchor="nw", text=explanationtitle, fill="#000000", font=("Encode Sans", 24 * -1))
...
class FinalScreen():
    ...
    scorebg_2 = finalscreen_canvas.create_image(
        391.0, 221.0, image=image_scorebg)
    ...
    yourscore_text = finalscreen_canvas.create_text(
        390.0, 118.0, anchor="center", text="", fill="#000000", font=("Encode Sans", 33 * -1))
    incorrect_text = finalscreen_canvas.create_text(
        390.0, 222.0, anchor="center", text="", fill="#000000", font=("Encode Sans", 33 * -1))
    highscore_text = finalscreen_canvas.create_text(
        391.0, 332.0, anchor="center", text="", fill="#000000", font=("Encode Sans", 33 * -1))
    feedback_text = finalscreen_canvas.create_text(
        390.0, 435.0, anchor="center", text="", fill="#000000", font=("Encode Sans", 19 * -1, "bold",))
    finalscreen_canvas.create_text(
        308.0, 44.0, anchor="nw", text="You Scored", fill="#000000", font=("Encode Sans", 35 * -1))
    finalscreen_canvas.create_text(
        310.0, 250.0, anchor="nw", text="High Score", fill="#000000", font=("Encode Sans", 35 * -1))
    finalscreen_canvas.create_text(
...
class HistoryScreen():
    ...
    tree = ttk.Treeview(historyscreen_canvas, columns=(
        'date', 'time', 'correct', 'incorrect', 'mode', '%'), show='headings')
    ...
    scrollbar = ttk.Scrollbar(historyscreen_canvas,
